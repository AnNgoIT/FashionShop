...
public class ProductController {
    ...
    public ResponseEntity<GenericResponse> getAll() {
        List<Product> categoryList = productRepository.findAllByIsActiveIsTrue();
    ...
    public ResponseEntity<GenericResponse> getOne(@PathVariable Integer productId) {
        try {
            Optional<Product> productOptional = productRepository.findByProductIdAndIsActiveIsTrue(productId);
