...
import { useStyleValues } from "@/hooks/useProducts";
...
const MainProduct = (props: MainProductProps) => {
  ...
  const { categories, brands, products, styleValues } = props;
  ...
  const styleValueList: StyleValue[] = styleValues;
  const priceMarks = [
    {
      value: 100000,
      label: "100K",
                ...
                <div className="pl-2">
                  <FormControl>
                    <FormGroup>
                      {styleValueList &&
                        styleValueList
                          .filter((styleValue) => styleValue.style.styleId == 2)
                          .map((value) => {
                            return (
                              <FormControlLabel
                                key={value.styleValueId}
                                value={value.name}
                                control={<Checkbox />}
                                label={value.name}
                              />
                ...
                <div className="text-text-color pl-2">
                  <FormControl>
                    <FormGroup>
                      {styleValueList &&
                        styleValueList
                          .filter((styleValue) => styleValue.style.styleId == 1)
                          .map((value) => {
                            return (
                              <FormControlLabel
                                key={value.styleValueId}
